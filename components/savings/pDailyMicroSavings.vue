<template>
  <v-container class="pa-0">
                ...
                <v-row no-gutters class="ma-0">
                  <v-col cols="12" sm="8" lg="9" class="d-flex align-center">
                    ...
                    <div class="d-flex flex-column ml-sm-4">
                      ...
                      <span class="secondary--text text-h5 text-sm-h4 font-weight-bold">{{ dmiSavings | currency }}</span>
                      <div class="mt-1">
    ...
    <p-autosave :type="1" :drawer="drawer.autosave" :toggle="toggle.autosave" />
  </v-container>
</template>
...
export default {
  ...
  computed: {
    ...
    dmiSavings () {
      return this.user && this.user.DmiWallet.balance
    },

    autoSavings () {
      return this.user && this.user.UserSetting.dmiAutoSave
    },
    toggle () {
      return {
        quicksave: (state) => {
