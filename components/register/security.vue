  ...
  <v-card flat max-width="450" class="rounded-lg px-md-4 py-2">
    <v-card-title class="d-flex flex-column justify-center font-weight-light text-subtitle-1 text-md-h6 mt-2">
      ...
      <div class="text-subtitle-1 text1--text text-center my-1 font-weight-light ">
        The final stage of creating your pelf account
      </div>
      <div class="text-subtitle-1">
        <span class="font-weight-medium mr-2">Edit your</span>
        <a style="text-decoration:underline" class="font-weight-medium" @click="setForm('Personal')">
          Personal details
        </a>
      </div>
    </v-card-title>
...
export default {
  ...
  methods: {
    ...mapActions({ sendOtp: 'authentication/sendOtp', initAlert: 'controller/initAlert' }),
    submit () {
